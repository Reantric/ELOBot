...
export default class EightPlyStrategy implements NimBotStrategy {
    ...
    getDescription(): string {
        return "An AI strategy that uses an 8-ply minimax algorithm with memoization to determine the best move in Nim.";
    }
